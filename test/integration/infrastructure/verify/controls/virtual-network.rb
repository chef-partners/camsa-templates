...
vnet_address_prefix = input('vnet_address_prefix', value: '10.3.0.0/24', description: 'The address space that has been assigned to the virtual network')
customer_subnet_prefix = input('customer_subnet_prefix', value: '10.3.0.0/25', description: 'The address space assigned to the customer subnet')
